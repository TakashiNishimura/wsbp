...
public class HomePage extends WebPage {
    ...
    public HomePage() {
        var youModel = Model.of("Wickdt-Spring-Boot");
        var youLabel = new Label("you", youModel);
        add(youLabel);

        var gakusekiModel = Model.of("b2181930");
        var gakusekiLabel = new Label("gakuseki", gakusekiModel);
        add(gakusekiLabel);
        var nameModel = Model.of("takoshi");
        ...
        var toSigninLink = new BookmarkablePageLink<>("toSignin", SignPage.class);
        add(toSigninLink);
